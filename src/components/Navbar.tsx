...
// Load LoginUser as a server component dynamically
const LoginUser = dynamic(() => import("./login-user"), { ssr: false });
        ...
        <nav className="bg-gray-100 border-border dark:bg-gray-800 dark:border-border ">
            <div className="max-w-(--breakpoint-xl) flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    >
                        <AiOutlineMenu
                            className={`h-[1.2rem w-[1.2rem] transition-all text-black dark:text-yellow-500 ${
                                isOpen ? "rotate-90 scale-0" : "rotate-0 scale-100"
                            }`}
                        />
                        <AiOutlineClose
                            className={`absolute h-[1.2rem] w-[1.2rem] transition-all text-black dark:text-yellow-500 ${
                ...
                <div className={`${isOpen ? "block" : "hidden"} w-full md:block md:w-auto`} id="navbar-default">
                    <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-border rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 bg-gray-100 dark:bg-gray-800 dark:border-border dark:text-foreground">
                        <li>
